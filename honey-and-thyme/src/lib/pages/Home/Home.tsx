...
function HomePageImage({ image, controllerValue, delayInSeconds, width, height, slowLoadImages }: HomePageImageProps) {
    const [loaded, setLoaded] = useState(false);
    console.log("Rendering image:", JSON.stringify(image));
...
function Home({ slowLoadImages = false }: HomeProps) {
    ...
    if (error) return <div className="p-4">Sorry, there was an issue loading the images.</div>;
    ...
    return (
        <div className="w-full">
            ...
            {isMobile ? (
                ...
                /* Desktop view */
                <div className="flex flex-col">
                    <div className="px-2 pt-15" style={{ height: Math.min(450, window.innerWidth / 2) }}>
                        <div className="h-full flex items-end">
                            <div className="flex-1" />
                            <div className="pr-6">
                                <HomePageImage
                    ...
                    <div className="p-2" style={{ height: Math.min(450, window.innerWidth / 2) }}>
                        <div className="h-full flex items-start">
                            <div className="flex-1" />
                            <div className="pr-2">
                                <HomePageImage
