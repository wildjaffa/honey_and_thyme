...
const pricingEntries: PricingEntryData[] = [
  {
    title: "The Mini - $85",
    description:
      "15 minutes with unlimited edited images back. Up to 5 people. Message for pricing for additional people",
  ...
  },
  {
    title: "The Half - $115",
    description:
      "30 minutes with unlimited edited images back. Up to 5 people. Message for pricing for additional people",
  ...
  },
  {
    title: "The Full - $150",
    description:
      "60 minutes with unlimited edited images back. Up to 5 people. Message for pricing for additional people.",
  ...
  },
  {
    ...
    description:
      "120 minutes with unlimited edited images back. Up to 5 people. Message for pricing for additional people.",
...
function PricingEntry({
  ...
  const imageSize = useImageSize(
    image as ImageModel,
    pricingEntryData.imageWidth * multiplier,
  );
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start">
        <h2 className="font-['IM_Fell_English_SC'] text-lg text-black">
          {pricingEntryData.title}
        </h2>
        <p
          className="font-['IM_Fell_English'] text-sm font-thin text-black"
          style={{ width: width - (imageSize.width + 50) }}
        >
          {pricingEntryData.description}
        </p>
        <HoneyButton onClick={() => navigate("/booking")} label="Book Now" />
      </div>
    </div>
  );
}
...
function Pricing() {
  ...
  if (error)
    return <div className="text-center">Error loading pricing page</div>;
          ...
          {pricingEntries.map((entry, index) => (
            <PricingEntry
              ...
              image={album?.images?.find(
                (img) => img.fileName === entry.fileName,
              )}
              backgroundColor={
                index % 2 === 0 ? "transparent" : "var(--color-honey-sage)"
              }
            />
          ))}

          <div className="px-4 py-8 text-center">
            <p className="font-['IM_Fell_English'] text-lg">
              Don't see what you need?{" "}
              <button
                onClick={() => navigate("/contact")}
                className="text-honey-gold cursor-pointer font-bold underline hover:text-[#8B6508]"
              >
                CONTACT ME
              </button>
